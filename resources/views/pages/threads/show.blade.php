<x-guest-layout>
    <main class="grid grid-cols-4 gap-8 mt-8 wrapper">
        ...
        <section class="flex flex-col col-span-3 gap-y-4">
            ...
            <article class="p-5 bg-white shadow">
                <div class="relative grid grid-cols-8">
                    ...
                    <div class="relative col-span-7 space-y-6">
                        <div class="space-y-3">
                            <h2 class="text-xl tracking-wide hover:text-green-400">
                                {{ $thread->title() }}
                            </h2>
                        ...
                        <div class="flex justify-between">
                            ...
                            <div class="flex space-x-5 text-gray-500">
                                ...
                                <div class="flex items-center space-x-2">
                                    <x-heroicon-o-eye class="w-4 h-4 text-green-300" />
            ...
            @else
            <div class="flex justify-between p-4 text-gray-700 bg-green-200 rounded">
